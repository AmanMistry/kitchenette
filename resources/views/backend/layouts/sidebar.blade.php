            ...
            <ul id="slide-out" class="sidenav">
                ...
                <li>
                    <ul class="collapsible">
                        ...
                        <li>
                            <a href="http://wrappixel.com/demos/admin-templates/materialart/html/ltr/logout.html" class="collapsible-header"><i class="material-icons">directions</i><span class="hide-menu"> Log Out </span></a>
                        </li>
                        <li>
                            <a href="http://wrappixel.com/demos/admin-templates/materialart/html/ltr/faqs.html" class="collapsible-header"><i class="material-icons">people_outline</i><span class="hide-menu"> FAQs </span></a>
                        </li>
                    </ul>
                </li>
            </ul>
