...
<div class="page-wrapper">
            ...
            <div class="col s12 l8">
                <div class="card news-slide" style="background:url(./assets/images/carousel/img6.jpg) center center / cover;">
                    <div class="carousel carousel-slider" >
                        <a class="carousel-item" href="index.html#one!">
                        ...
                        <a class="carousel-item" href="index.html#one!" style="background:url(./assets/images/carousel/img6.jpg) center center / cover;">
                            <div class="carousel-caption">
    ...
    <!-- Container fluid scss in scafholding.scss -->
    <!-- ============================================================== -->
    <footer class="center-align m-b-30">All Rights Reserved by Materialart. Designed and Developed by <a href="../../../../../wrappixel_default_3.html">WrapPixel</a>.</footer>
</div>
<!-- ============================================================== -->
...
<!-- Right Sidebar -->
<!-- ============================================================== -->
<a href="index.html#" data-target="right-slide-out" class="sidenav-trigger right-side-toggle btn-floating btn-large waves-effect waves-light red"><i class="material-icons">settings</i></a>
        ...
        <li>
            <div class="row">
                <div class="col s12">
                    <!-- Tabs -->
                    <ul class="tabs">
                        <li class="tab col s4"><a href="index.html#settings" class="active"><span class="material-icons">build</span></a></li>
                        <li class="tab col s4"><a href="index.html#chat"><span class="material-icons">chat_bubble</span></a></li>
                        <li class="tab col s4"><a href="index.html#activity"><span class="material-icons">local_activity</span></a></li>
                    </ul>
                    <!-- Tabs -->
                </div>
                <!-- Setting -->
                    ...
                    <ul class="mailbox m-t-20">
                        <li>
                            <div class="message-center">
                                <!-- Message -->
                                <a href="index.html#" class="user-info" id='chat_user_1' data-user-id='1'>
                                    <span class="user-img">
                                ...
                                <!-- Message -->
                                <a href="index.html#" class="user-info" id='chat_user_2' data-user-id='2'>
                                    <span class="user-img">
                                ...
                                <!-- Message -->
                                <a href="index.html#" class="user-info" id='chat_user_3' data-user-id='3'>
                                    <span class="user-img">
                                ...
                                <!-- Message -->
                                <a href="index.html#" class="user-info" id='chat_user_4' data-user-id='4'>
                                    <span class="user-img">
                                ...
                                <!-- Message -->
                                <a href="index.html#" class="user-info" id='chat_user_5' data-user-id='5'>
                                    <span class="user-img">
                                        <img src="./assets/images/users/1.jpg" alt="user" class="circle">
                                        <span class="profile-status online pull-right" data-status="online"></span>
                                    </span>
                                ...
                                <!-- Message -->
                                <a href="index.html#" class="user-info" id='chat_user_6' data-user-id='6'>
                                    <span class="user-img">
                                        <img src="./assets/images/users/2.jpg" alt="user" class="circle">
                                        <span class="profile-status busy pull-right" data-status="busy"></span>
                                    </span>
                                ...
                                <!-- Message -->
                                <a href="index.html#" class="user-info" id='chat_user_7' data-user-id='7'>
                                    <span class="user-img">
                                        <img src="./assets/images/users/3.jpg" alt="user" class="circle">
                                        <span class="profile-status away pull-right" data-status="away"></span>
                                    </span>
                                ...
                                <!-- Message -->
                                <a href="index.html#" class="user-info" id='chat_user_8' data-user-id='8'>
                                    <span class="user-img">
                                        <img src="./assets/images/users/4.jpg" alt="user" class="circle">
                                        <span class="profile-status offline pull-right" data-status="offline"></span>
                                    </span>
                                ...
                                <!-- Message -->
                                <a href="index.html#" class="user-info" id='chat_user_9' data-user-id='9'>
                                    <span class="user-img">
                                        <img src="./assets/images/users/1.jpg" alt="user" class="circle">
                                        <span class="profile-status online pull-right" data-status="online"></span>
                                    </span>
                                ...
                                <!-- Message -->
                                <a href="index.html#" class="user-info" id='chat_user_10' data-user-id='10'>
                                    <span class="user-img">
                                        <img src="./assets/images/users/2.jpg" alt="user" class="circle">
                                        <span class="profile-status busy pull-right" data-status="busy"></span>
                                    </span>
                                ...
                                <!-- Message -->
                                <a href="index.html#" class="user-info" id='chat_user_11' data-user-id='11'>
                                    <span class="user-img">
                                        <img src="./assets/images/users/3.jpg" alt="user" class="circle">
                                        <span class="profile-status away pull-right" data-status="away"></span>
                                    </span>
                                ...
                                <!-- Message -->
                                <a href="index.html#" class="user-info" id='chat_user_12' data-user-id='12'>
                                    <span class="user-img">
                                        <img src="./assets/images/users/4.jpg" alt="user" class="circle">
                                        <span class="profile-status offline pull-right" data-status="offline"></span>
                                    </span>
