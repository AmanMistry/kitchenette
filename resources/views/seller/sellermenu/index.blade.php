    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <table class="table">
                <tr>
                    <th> Menu </th>
                    <th><a href="{{ route("sellermenu.create") }}" class="btn btn-primary">Add new Menu</a></th>
                ...
                <table class="table table-hover table-striped">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route("sellermenu.show",$post->id) }}" class="btn btn-primary">View</a>

                            <a href="{{ route("sellermenu.edit",$post->id) }}" class="btn btn-success">Edit</a>
                            
                            <a href="{{ "deleteSmenu/".$post->id }}" class="btn btn-danger">Delete</a>
