        ...
        <nav class="nav">
            <div> <a href="#" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> <span class="nav_logo-name">Kitchenette</span> </a>
                <div class="nav_list"> <a href="/seller" class="nav_link"> <i class='bx bx-grid-alt nav_icon'></i> <span class="nav_name">Dashboard</span> </a>
                    ...
                    <a href="{{ route('sellerorder.index') }}" class="nav_link active"> <i class='bx bx-message-square-detail nav_icon'></i> <span class="nav_name">Orders</span> </a>
...
<!--seller change pass profile start-->
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                    ...
                    <table class="table table-hover table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ "sellerorderview/".$post->id }}" class="btn btn-primary">View</a>
                                <a href="{{ "deleteSdelete/".$post->id }}" class="btn btn-danger">Delete</a>
...
<!--seller change pass profile end-->
